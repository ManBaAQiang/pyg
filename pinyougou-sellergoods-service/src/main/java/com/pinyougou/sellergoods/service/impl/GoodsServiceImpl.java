...
public class GoodsServiceImpl implements GoodsService {
	...
	public void add(Goods goods) {
		...
		goodsDescMapper.insert(goods.getGoodsDesc());//插入品牌的扩展信息
		
		saveItemList(goods); //插入商品的sku数据
		/*
	...
	public void update(Goods goods){
		goods.getGoods().setAuditStatus("0");//设置为申请状态，如果是修改的商品需要重新设置状态
...
//		goodsMapper.updateByPrimaryKey(goods);
	...
	public Goods findOne(Long id){
		...
		com.pinyougou.pojo.TbItemExample.Criteria criteria = tbItemExample.createCriteria();
